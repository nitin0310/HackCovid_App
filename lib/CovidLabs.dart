...
class CovidLabs extends StatefulWidget {
  @override
  _CovidLabsState createState() => _CovidLabsState();
}

class _CovidLabsState extends State<CovidLabs> {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        appBar: AppBar(
          ...
          elevation: 5.0,
          centerTitle: true,
          title: Text("COVID-19 Testing Labs",style: TextStyle(color: Colors.white),),
        ),
        body: FutureBuilder(
              future: states,
